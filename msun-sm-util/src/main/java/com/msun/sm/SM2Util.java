 ...
 */
 public  class SM2Util {
    ...
    // 获取SM2相关参数
     static X9ECParameters parameters;
    // 椭圆曲线参数规格
   ...
   public SM2Util(){
    ...
    public static String encode(String input, String pubKey)
        ...
        //数据hex的加密结果
        System.out.println( "加密结果：" + Hex.toHexString(cipher.doFinal(input.getBytes())));
        // 加密并编码为base64格式
     ...
     * @return
     */
    public static byte[] decoder(String input, String prvKey) throws NoSuchPaddingException, NoSuchAlgorithmException,
     ...
     */
    public static String sign(String plainText, String prvKey) throws NoSuchAlgorithmException, InvalidKeySpecException,
    ...
    public static boolean verify(String plainText, String signatureValue, String pubKey) throws NoSuchAlgorithmException, InvalidKeySpecException,
            InvalidKeyException, SignatureException {
        // 创建签名对象
        Signature signature = Signature.getInstance(GMObjectIdentifiers.sm2sign_with_sm3.toString(), provider);
        // 将公钥HEX字符串转换为椭圆曲线对应的点
    ...
    public static void main(String[] args) throws InvalidAlgorithmParameterException, NoSuchAlgorithmException {
        ...
        // 拿到密钥
        //publicKey.getQ().getEncoded(false) 未压缩公钥
        String pubKey = new String(Hex.encode(publicKey.getQ().getEncoded(false)));
        byte[] prvKeyBytes = privateKey.getD().toByteArray();
        String prvKey = new String(Hex.encode(prvKeyBytes));
//        String pubKey = "04d834175f4197cdccb3c5d1c693454f94104ae6cfa964747680b4c6c297f2fcee1ea7f31d41ac33b9bab514c300ee50d946262c3066981b0ee109794f0658f0c9";
//        String prvKey = "b71fe5249cd20fd689f90439ae67e7381ed5a54834b59c409833dcecd579e7d3";
